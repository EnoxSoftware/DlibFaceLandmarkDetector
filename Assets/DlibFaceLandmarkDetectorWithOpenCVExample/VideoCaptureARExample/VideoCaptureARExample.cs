...
{
    /// <summary>
    /// Face tracker AR from VideoCapture Example.
    ...
    /// </summary>
    public class VideoCaptureARExample : MonoBehaviour
    {
        /// <summary>
        ...
        private IEnumerator getFilePathCoroutine ()
        {
            ...
            coroutineStack.Push (getFilePathAsync_dance_avi_filepath_Coroutine);
